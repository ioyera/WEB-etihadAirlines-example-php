...
<head>
    ...
    <title> ETIHAD - DREAM OF YOUR FLIGHTS </title>
	<!-- Windows 8 Tiles -->
	...
	<body>
		<div class="pushWrapper">
			...
			<header class="pageHeader">
				...
				<!-- Logo -->
			    <a class="headerLogo smoothScroll" href="reg.php">
			...
			<div class="sidebar">
				...
				<nav class="mainMenu">
					<ul class="menu">
						<li>
							<a class="smoothScroll" href="#timeline-part" title="What Is Luxury?"><i class="step icon-question size-24"></i><span class="text">What is ETIHAD?</span></a>
						</li>
						<li>
							<a class="smoothScroll" href="#stastistical-part" title="Services"><i class="icon-reciept-1 size-24"></i><span class="text">STATISTIC</span></a>
						</li>
						<li>
						...
						<li>
							<a class="smoothScroll" href="reg.php" title="Contact Form"><i class=" step icon-diamond size-24"></i><span class="text">SIGN UP</span></a>
						</li>
					</ul>
				</nav>
			...
			<div class="content">
				<div class="container-template">
				    <h1>
				        ...
				        <span class="seconday">World Class</span>
	...
	<div class="content">
		<div class="container-template">
		    ...
		    <div class="intro content-template">
		        <p><strong>The number-one ETIHAD property showcase on the web, today. </strong></p>
				<p>ETIHAD AIRLINES, the number-one purveyor of ETIHAD AIRLINES in the world, is proud to prsent this short online showcase to you. We hope you enjoy it.</p>
				<p>ETIHAD AIRLINES is the &#8216;hidden gem&#8217; of the global ETIHAD market, with a target audience of the most discerning high net worth individuals globally.</p>
		    </div>

		    <ul class="timeline">					
					<li class="year">2012</li>
				    <li class="upper-line">
				    	<span class="title">Founded by John Doe in 2012</span>
				    	<span class="timeline-content paragraph-text">&#8220;My motive in launching ETIHAD was to create a wider platform for ETIHAD Property Developers to better showcase their work..&#8221;
						<strong>John Doe, FOUNDER &amp; MANAGING DIRECTOR</strong>
						</span>
				    </li>
				    ...
				    <li class="upper-line">
				    	<span class="title">2800 + people buy and sell their property in a year</span>
				    	<span class="paragraph-text timeline-content">
				    		The website combines a ETIHAD AIRLINES that gives both members of where to go on a practical level to find the best of the best in the world.
						</span>
				    </li>

				    <li class="year">2014</li>
				    <li class="upper-line">
				    	<span class="title">ETIHAD started their business around the globe.
				    	</span>
				    	<span class="timeline-content">
				    		We have our business in 12 countries all over the world. We want to spread it throughout the world. You can contribute us joining the winning the team
						</span>
				    </li>
			    </ul>
		    </div>
				...
				<div class="container-template">
					...
					<div class="headergroup">
						<h2>
					        ...
					        <span>&quot;ETIHAD Modern Homes&quot;</span>
					    </h2>
				    </div>
				    <div class="intro container-template">
				    	<p>Since 2012, the ETIHAD have introduced themselves in many countries:</p>
				    </div>
		...
		<section class="featured-part" id="featured-part">
			...
			<div class="content">
				<div class="container-template">
				    ...
				    <div class="intro content-template">
				        <p>ETIHAD operates on in over 155 countries all over the world: <strong>Apartments</strong>, <strong>Condos</strong> and <strong>Mansions</strong>.</p>
				    </div>
				    <br>
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner">
				    ...
				    <div class="item">
				      <img src="images/545505.jpg" alt="...">
				      <div class="carousel-caption">
				        
				      </div>
				    </div>
				     <div class="item">
				      <img src="images/1392599.jpg" alt="...">
				      <div class="carousel-caption">
			 		...
			 		<ul class="team-members">
		 				...
		 				<li>
		 					...
		 					<h3 class="team-member-title">
		 						<span class="seconday">John Doe</span> 						
		 					</h3>

		 					<div class="team-member-text content-template">
		 						<p>Founder of ETIHAD. Doe has 27 years experience in high-end ETIHAD, commercial and residential development.</p>
		 					</div>
		 				</li>
					</ul>
				</div>
